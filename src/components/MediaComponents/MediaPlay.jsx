    ...
    return (
        <div className='absolute h-full w-full top-0 left-0 flex items-center justify-center bg-black bg-opacity-60 rounded-lg'>
            <button
                ...
                className="px-1 py-1 flex gap-3 items-center bg-gray-950 hover:bg-red-600 hover:text-black text-lg font-semibold rounded-full duration-100"
            >
                <IoPlayCircle className='text-5xl' />
                {/* <span>Play</span> */}
            </button>
        </div>
    )
