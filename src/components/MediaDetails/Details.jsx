...
import ShimmerUiDetailsPage from "../ShimmarUi/ShimmerUiDetailsPage";
    ...
    return (
        <div className="mr-2 py-6 px-2 bg-leanblue">
            ...
            <button
                ...
                className="px-6 py-3 mb-2 bg-red-600 text-black font-semibold rounded-xl hover:bg-red-400 transition duration-300"
            >
                <span>Go Back</span>
            </button>
            {
