...
import ShimmerUi from '../components/ShimmarUi/ShimmerUi';
...

            {
                isAuthenticated ? <>
                    ...
                    <div className='flex flex-col gap-4'>
                        ...
                        <Link
                            to="/profile"
                            className="px-6 py-3 w-32 text-center bg-red-600 text-black font-semibold rounded-lg hover:bg-red-400 transition duration-300"
                        >
                            Visit Here
                        </Link>
                    </div>
